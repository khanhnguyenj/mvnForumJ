/**
 * $Id: editor_template.js,v 1.3 2009/04/13 08:30:09 nguyendnc Exp $
 *
 * @author Moxiecode
    ...
    tinymce.create('tinymce.themes.AdvancedTheme', {
        ...
        init : function(ed, url) {
            ...
            t.settings = s = extend({
                ...
                theme_advanced_fonts : "arial=arial;times new roman=times new roman;courier new=courier new;century gothic=century gothic",
            ...
            if (!s.font_size_style_values)
                s.font_size_style_values = "8pt,10pt,12pt,14pt,18pt,24pt";
