	...
	tinymce.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
		ColorSplitButton : function(id, s) {
			...
			t.settings = s = tinymce.extend({
				colors : 'skyblue,royalblue,blue,darkblue,orange,orangered,crimson,red,firebrick,darkred,green,limegreen,seagreen,deeppink,tomato,coral,purple,indigo,Burlywood,sandybrown,sienna,Chocolate,teal,silver',
				grid_width : 8,
