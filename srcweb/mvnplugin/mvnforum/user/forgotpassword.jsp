<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/forgotpassword.jsp,v 1.73 2009/08/13 07:24:43 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.73 $
...
function reloadcaptcha() {
  document.getElementById("captchaimg").src='<%=urlResolver.encodeURL(request, response, "captchaimage?reload=true&amp;time=")%>'+new Date().getTime();
}
//]]>
</script>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="MemberName"><fmt:message key="mvnforum.common.member.login_name"/><span class="requiredfield"> *</span></label></td>
    <td><input type="text" id="MemberName" name="MemberName" size="60" maxlength="30" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><label for="MemberEmail"><fmt:message key="mvnforum.common.member.email"/><span class="requiredfield"> *</span></label></td>
    <td><input type="text" id="MemberEmail" name="MemberEmail" size="60" /></td>
  </tr>
<%if (MVNForumConfig.getEnableCaptcha()) {%>
  <tr class="<mvn:cssrow/>">
    ...
    <td>
      ...
      &nbsp;<img src="<%=contextPath%>/mvnplugin/mvnforum/images/icon/icon_refresh.gif" alt="<fmt:message key="mvnforum.common.captcha.refresh"/>" title="<fmt:message key="mvnforum.common.captcha.refresh"/>" border="0" onclick="reloadcaptcha()" />
    </td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td><label for="CaptchaResponse"><fmt:message key="mvnforum.common.captcha.response"/><span class="requiredfield"> *</span></label></td>
    <td><input type="text" size="60" id="CaptchaResponse" name="CaptchaResponse" value="" /></td>
  </tr>
<%}// end if captcha%>
