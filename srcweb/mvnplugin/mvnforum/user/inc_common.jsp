<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/inc_common.jsp,v 1.45 2010/06/22 02:32:45 minhnn Exp $
 - $Author: minhnn $
 - $Revision: 1.45 $
...
boolean isPollPortlet = "true".equals(request.getAttribute("isPollPortlet"));
boolean isAlbumPortlet = "true".equals(request.getAttribute("isAlbumPortlet"));
%>
