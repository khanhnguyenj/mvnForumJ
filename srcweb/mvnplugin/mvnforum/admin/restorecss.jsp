<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/restorecss.jsp,v 1.13 2009/08/13 09:11:57 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.13 $
...
<mvn:head>
  <mvn:title><fmt:message key="mvnforum.common.forum.title_name"/> - <fmt:message key="mvnforum.admin.restorecss.title"/></mvn:title>
...
<div class="nav center">
  ...
  <fmt:message key="mvnforum.admin.restorecss.title"/>
</div>
<br/>

<div class="pagedesc warning">
  <fmt:message key="mvnforum.admin.restorecss.warning"/>
</div>

<br/>
<!-- the onSubmit event prevent from being submitted by pressing enter  -->
<form action="<%=urlResolver.encodeURL(request, response, "restorecssprocess", URLResolverService.ACTION_URL)%>" method="post" name="submitform" onsubmit="return false;">
<%=urlResolver.generateFormAction(request, response, "restorecssprocess")%>
<mvn:securitytoken />
<input type="hidden" name="md5pw" value="" />
<mvn:cssrows>
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  <tr class="portlet-section-header">
    <td colspan="2"><fmt:message key="mvnforum.common.prompt.current_password"/>:</td>
  </tr>
  <tr class="<mvn:cssrow/>">
  ...
  <tr class="portlet-section-footer">
    ...
    <input type="button" name="submitbutton" value="<fmt:message key="mvnforum.admin.restorecss.button"/>" onclick="javascript:SubmitForm();" class="portlet-form-button" />
