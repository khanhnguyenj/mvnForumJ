<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/login.jsp,v 1.95 2009/08/13 09:11:56 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.95 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="MemberMatkhau"><fmt:message key="mvnforum.common.member.password"/><span class="requiredfield"> *</span></label></td>
