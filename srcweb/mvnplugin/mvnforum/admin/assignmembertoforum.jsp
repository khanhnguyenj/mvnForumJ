<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/assignmembertoforum.jsp,v 1.95 2009/07/16 03:21:12 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.95 $
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td align="center">
      <table class="noborder">
        <tr>
          <td width="30%">
            <label for="member"><fmt:message key="mvnforum.common.member.login_name"/>:</label> 
          </td>
          <td width="70%">
            <input type="text" id="member" name="member" size="30" /> <fmt:message key="mvnforum.common.or"/><br/>
          </td>
        </tr>
        <tr>
          <td width="30%">
            <label for="memberid"><fmt:message key="mvnforum.common.member.id"/>:</label>
          </td>
          <td width="70%">
