-- $Header: /cvsroot/mvnforum/mvnforum/sql/upgrade/1_0_0_rc3_to_1_0_0_rc4/mvnforum_update_Sybase.sql,v 1.5 2007/07/02 13:05:31 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.5 $
...
-- Note: When the AttachDesc's date type was TEXT, comment this query to upgrade
-- Because the altered column cannot be a column with a text, image, text, or timestamp data type.
ALTER TABLE mvnforumAttachment ALTER COLUMN AttachDesc TEXT NOT NULL;
