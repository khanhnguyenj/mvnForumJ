...
-- $Header: /cvsroot/mvnforum/mvnforum/sql/mvnForum_DB2.sql,v 1.30 2010/04/06 11:11:32 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.30 $
...
-- LONGVARCHAR    : LONG VARCHAR (<= 32740)
--                  CLOB
-- DATE           : DATE
-- TIMESTAMP      : TIMESTAMP
-- VARCHAR        : VARCHAR
-- BLOB           : BLOB(n) where n <= 15,000,000 (<= 2GB in http://www-12.lotus.com/ldd/doc/lei/652/lccon6.nsf/b3266a3c17f9bb7085256b870069c0a9/8d2bab4f39bdc9ac85256e29006522cf?OpenDocument)
-- now()          : CURRENT DATE
...
INSERT INTO mvnforumMemberGroup (GroupID, MemberID, MemberName, Privilege, CreationDate, ModifiedDate, ExpireDate)
                         VALUES (3,       1,       'admin',     0,       CURRENT TIMESTAMP, CURRENT TIMESTAMP, CURRENT TIMESTAMP);
