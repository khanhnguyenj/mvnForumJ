<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/splitthread.jsp,v 1.33 2009/08/13 07:24:43 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.33 $
...
<div class="pagedesc warning">
  <fmt:message key="mvnforum.user.splitthread.guide"/>
</div>
<br/>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td width="35%"><label for="PostTopic"><fmt:message key="mvnforum.common.thread.topic"/><span class="requiredfield"> *</span></label></td>
    <td><input type="text" id="PostTopic" name="PostTopic" value="" size="70" class="bginput" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="destforum"><fmt:message key="mvnforum.user.splitthread.destination_forum"/><span class="requiredfield"> *</span></label></td>
