<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editgrouppermission.jsp,v 1.96 2009/08/13 09:11:56 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.96 $
...
<form action="<%=urlResolver.encodeURL(request, response, "updategrouppermission", URLResolverService.ACTION_URL)%>" method="post" name="submitform" onsubmit="return false;">
