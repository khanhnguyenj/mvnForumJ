<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editgroupinfo.jsp,v 1.88 2009/08/13 09:11:56 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.88 $
...
<form action="<%=urlResolver.encodeURL(request, response, "updategroupinfo", URLResolverService.ACTION_URL)%>" method="post" name="submitform" onsubmit="return false;">
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="GroupName"><fmt:message key="mvnforum.common.group.group_name"/><span class="requiredfield"> *</span></label></td>
    <td><input type="text" id="GroupName" name="GroupName" value="<%=groupBean.getGroupName()%>" size="60" onkeyup="initTyper(this);" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
    <td valign="top"><label for="GroupDesc"><fmt:message key="mvnforum.common.group.group_description"/><span class="requiredfield"> *</span></label></td>
    <td><textarea cols="60" rows="6" id="GroupDesc" name="GroupDesc" onkeyup="initTyper(this);"><%=groupBean.getGroupDesc()%></textarea></td>
  </tr>
  <tr class="<mvn:cssrow/>">
