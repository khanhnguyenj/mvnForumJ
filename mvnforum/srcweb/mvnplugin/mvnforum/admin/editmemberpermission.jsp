<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/editmemberpermission.jsp,v 1.90 2009/08/13 09:11:56 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.90 $
...
<br/>
<form action="<%=urlResolver.encodeURL(request, response, "updatememberpermission", URLResolverService.ACTION_URL)%>" method="post" name="submitform" id="submitform" onsubmit="return false;">
