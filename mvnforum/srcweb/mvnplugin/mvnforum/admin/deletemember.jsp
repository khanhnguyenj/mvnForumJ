<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/deletemember.jsp,v 1.78 2009/08/13 09:11:56 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.78 $
...
<div class="pagedesc warning">
  <fmt:message key="mvnforum.admin.deletemember.warning"/>
</div>
...
<table class="tborder" width="95%" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr class="<mvn:cssrow/>">
    ...
    <td><input type="checkbox" id="deletesentmessages" name="deletesentmessages" class="noborder" value="<fmt:message key="mvnforum.common.yes"/>" /></td>
  </tr>
  <tr class="<mvn:cssrow/>">
