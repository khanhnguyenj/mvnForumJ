<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/systemoverloaded.jsp,v 1.1 2008/07/16 05:00:16 tbtrung Exp $
 - $Author: tbtrung $
 - $Revision: 1.1 $
 - $Date: 2008/07/16 05:00:16 $
 -
 - ====================================================================
 -
...
<mvn:head>
  <mvn:title>The server is too busy at the moment</mvn:title>
</mvn:head>
<mvn:body>
