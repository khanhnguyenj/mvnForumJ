/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/MVNForumConfig.java,v 1.292 2010/08/10 11:52:50 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.292 $
...
public final class MVNForumConfig {
    ...
    private static final Logger log = LoggerFactory.getLogger(MVNForumConfig.class);
    ...
    private static void setMVNForumHome(String home) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                ...
                log.debug("Absolute filename of temp file for testing write access = " + tempFile.getAbsolutePath());
            }
            ...
            MvnCoreServiceFactory.getMvnCoreService().getEnvironmentService().setShouldStop("Check your mvnForumHome. Detail : " + ex.getMessage());
    ...
    public static final long SESSION_DURATION    = 30 * DateUtil.MINUTE; // SHOULD NOT less than 15 minutes
    ...
    */
    ...
    public static void reload() {
        ...
        try {
            ...
            FloodControlHour.setOption(MVNForumGlobal.FLOOD_ID_NEW_POST_PER_MEMBER, maxPostsPerHourPerMember);
            FloodControlHour.setOption(MVNForumGlobal.FLOOD_ID_LOGIN_PER_IP, maxLoginsPerHourPerIP);
            FloodControlHour.setOption(MVNForumGlobal.FLOOD_ID_NEW_MESSAGE_PER_IP, maxMessagesPerHourPerIP);
            FloodControlHour.setOption(MVNForumGlobal.FLOOD_ID_HTTP_REQUEST_PER_IP, maxHttpRequestsPerHourPerIP);
            FloodControlMinute.setOption(MVNForumGlobal.FLOOD_ID_HTTP_REQUEST_PER_IP, maxHttpRequestsPerMinutePerIP);
    ...
    public static boolean supportLocale(String localeName) {
        ...
        if (supportedLocaleNames == null) {
            log.error("Assertion in MVNForumConfig: supportedLocales is null. Please check your configuration.");
            return false;
        }
