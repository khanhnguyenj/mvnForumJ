/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/AdminModuleConfig.java,v 1.18 2008/12/31 03:50:24 trungth Exp $
 * $Author: trungth $
 * $Revision: 1.18 $
...
public final class AdminModuleConfig {
    ...
    private static String urlPattern = "/mvnforumadmin";
    ...
    static {
        try {
            ...
            urlPattern = conf.getString("adminmoduleconfig.url_pattern", urlPattern);
        } catch (Exception e) {
