...
//      for sort and order stuff
    ...
    public static void deleteMember(MemberBean memberBean, boolean deleteSentMessages, GenericRequest request, Locale locale)
        ...
        if ((memberBean.getMemberPostCount() > 0) || (DAOFactory.getPostDAO().getNumberOfPosts_inMember(memberID) > 0)) {
        ...
        boolean shouldDelete = MvnForumServiceFactory.getMvnForumService().getMvnForumDatabaseService().deleteMember(memberBean, request);
