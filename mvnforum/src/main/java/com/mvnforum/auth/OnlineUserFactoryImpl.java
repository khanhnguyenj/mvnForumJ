/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/auth/OnlineUserFactoryImpl.java,v 1.68 2009/08/31 03:47:16 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.68 $
 * $Date: 2009/08/31 03:47:16 $
 *
 * ====================================================================
 *
...
public class OnlineUserFactoryImpl implements OnlineUserFactory {
    ...
    public OnlineUser getAuthenticatedUser(GenericRequest request,
        ...
        try {
            ...
            MvnCoreServiceFactory.getMvnCoreService().getEnvironmentService().setShouldStop("Assertion in OnlineUserFactoryImpl.", EnvironmentService.DEFAULT_RUN_RETRY);
            log.error("Unexpected error validating user", e);
    ...
    public OnlineUser getAnonymousUser(GenericRequest request, GenericResponse response)
        ...
        Cookie languageCookie = getCookieByName(MVNForumConstant.MVNFORUM_COOKIE_GUEST_LANGUAGE, arrayOfCookies);
        if (languageCookie != null) {
            localeName = languageCookie.getValue();
        }
        Cookie timeZoneCookie = getCookieByName(MVNForumConstant.MVNFORUM_COOKIE_GUEST_TIMEZONE, arrayOfCookies);
        ...
        Cookie guestPostPerPageCookie = getCookieByName(MVNForumConstant.MVNFORUM_COOKIE_GUEST_POSTS_PER_PAGE, arrayOfCookies);
    ...
    public void postLogin(HttpServletRequest request, HttpServletResponse response, OnlineUser onlineUser)
        ...
        int numberOfMessageFolders = DAOFactory.getMessageFolderDAO().getNumberOfMessageFolders_inMember(onlineUser.getMemberID());
