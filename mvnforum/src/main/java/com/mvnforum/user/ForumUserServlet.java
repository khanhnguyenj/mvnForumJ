/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/ForumUserServlet.java,v 1.89 2009/12/21 07:57:48 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.89 $
 * $Date: 2009/12/21 07:57:48 $
 *
 * ====================================================================
 *
...
public class ForumUserServlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(ForumUserServlet.class);
    ...
    public void process(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            environmentService.setShouldStop("Assertion in ForumUserServlet.", EnvironmentService.DEFAULT_RUN_RETRY);
