/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/PmAttachmentWebHandler.java,v 1.80 2009/04/09 07:15:55 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.80 $
 * $Date: 2009/04/09 07:15:55 $
 *
 * ====================================================================
 *
...
public class PmAttachmentWebHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(PmAttachmentWebHandler.class);
