/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/MemberWebHandler.java,v 1.233 2010/06/17 10:25:59 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.233 $
 * $Date: 2010/06/17 10:25:59 $
 *
 * ====================================================================
 *
...
public class MemberWebHandler {
    ...
    public void processAdd(GenericRequest request, GenericResponse response)
        ...
        try {
            ...
            Integer maxRegisters = new Integer(FloodControlHour.getActionsPerHour(MVNForumGlobal.FLOOD_ID_NEW_MEMBER_PER_IP));
    ...
    public void processUpdatePassword(GenericRequest request)
        ...
        if ( (memberPassword1.length() == 0) || (memberPassword1.endsWith("==") == false) ) {
            memberPassword = Encoder.getMD5_Base64(GenericParamUtil.getParameterPassword(request, "MemberMatkhau", 3, 0));
        }
 ...
 *************************************************/
    ...
    public void getAvatar(HttpServletRequest request, HttpServletResponse response)
        ...
        /*
        if (memberAvatar.startsWith(BinaryStorageService.BINARY_STORAGE) == false) {
