/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/GroupPermissionDAOImplJDBC.java,v 1.15 2009/01/02 15:12:55 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.15 $
...
public class GroupPermissionDAOImplJDBC implements GroupPermissionDAO {
    ...
    private static final Logger log = LoggerFactory.getLogger(GroupPermissionDAOImplJDBC.class);
