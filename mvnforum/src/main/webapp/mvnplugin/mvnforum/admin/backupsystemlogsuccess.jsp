<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/admin/backupsystemlogsuccess.jsp,v 1.41 2009/07/16 03:21:13 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.41 $
...
<div class="nav center">
  ...
  <a href="<%=urlResolver.encodeURL(request, response, "listlogfiles")%>"><fmt:message key="mvnforum.admin.listlogfiles.title"/></a>&nbsp;&raquo;&nbsp;
