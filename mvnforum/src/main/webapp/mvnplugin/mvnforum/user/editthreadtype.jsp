<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/editthreadtype.jsp,v 1.48 2009/08/13 07:24:43 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.48 $
...
<div class="pagedesc warning">
  <fmt:message key="mvnforum.user.editthreadtype.guide"/>
</div>
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td><label for="ThreadType"><fmt:message key="mvnforum.common.thread.type"/></label></td>
    <td>
