<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/editattachment.jsp,v 1.52 2009/08/13 07:24:43 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.52 $
...
<mvn:cssrows>
  ...
  <tr class="<mvn:cssrow/>">
    <td valign="top"><label for="newdesc"><fmt:message key="mvnforum.common.attachment.attach_desc"/></label></td>
    <td><textarea cols="50" rows="3" id="newdesc" name="newdesc"><%=DisableHtmlTagFilter.filter(attachmentBean.getAttachDesc())%></textarea></td>
  </tr>
  <tr class="<mvn:cssrow/>">
