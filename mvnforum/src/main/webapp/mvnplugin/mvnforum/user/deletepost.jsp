<%--
 - $Header: /cvsroot/mvnforum/mvnforum/srcweb/mvnplugin/mvnforum/user/deletepost.jsp,v 1.76 2009/08/13 07:24:43 thonh Exp $
 - $Author: thonh $
 - $Revision: 1.76 $
...
<div class="pagedesc warning">
  <fmt:message key="mvnforum.user.deletepost.guide"/>
</div>
