/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/auth/MVNForumPermissionFactory.java,v 1.34 2008/12/10 10:36:39 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.34 $
 * $Date: 2008/12/10 10:36:39 $
 *
 * ====================================================================
 *
...
public final class MVNForumPermissionFactory {
    ...
    public static MVNForumPermission getAuthenticatedPermission(MemberBean memberBean)
        ...
        Collection forumGroupMemberPermList = MVNForumPermissionWebHelper.getGroupMemberPermissionsInForums(memberID);
