/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/MemberForumDAOImplJDBC.java,v 1.14 2009/01/02 15:12:55 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.14 $
...
public class MemberForumDAOImplJDBC implements MemberForumDAO {
    ...
    private static final Logger log = LoggerFactory.getLogger(MemberForumDAOImplJDBC.class);
