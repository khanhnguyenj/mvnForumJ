/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/interceptor/PasswordInterceptor.java,v 1.3 2009/10/12 04:04:31 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.3 $
...
public interface PasswordInterceptor {
     ...
     * @throws InterceptorException if the password is not valid
     */
