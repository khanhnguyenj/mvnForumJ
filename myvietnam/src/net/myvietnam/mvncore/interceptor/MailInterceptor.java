/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/interceptor/MailInterceptor.java,v 1.6 2009/10/12 04:04:31 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.6 $
...
public interface MailInterceptor {
     ...
     * @throws InterceptorException if the email is invalid
     */
