/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/util/StringUtil.java,v 1.83 2009/12/23 10:08:44 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.83 $
 * $Date: 2009/12/23 10:08:44 $
 *
 * ====================================================================
 *
...
public final class StringUtil {
        ...
        for (int i=0; i< chTagNames.length; i++) {
            if (Character.isSpaceChar(chTagNames[i])) {
                if (inQuote == false) {
                    ...
                    if (Character.isSpaceChar(chTagNames[i+1]) || chTagNames[i-1] == '"' || chTagNames[i+1] == '"' || Character.isSpaceChar(chTagNames[i-1]) || Character.isSpaceChar(chTagNames[i-1])==false) {
                        continue;
                    }
                    ...
                    if (Character.isSpaceChar(chTagNames[i+1]) || chTagNames[i-1] == '"'|| chTagNames[i+1] == '"') {
                        continue;
                    }
     ...
     * otherwise return the string that has been trimmed
     * 
     * @param str the input
     ...
     * @param locale TODO
     */
    public static void checkGoodName(String str, boolean allowSpace, Locale locale) throws BadInputException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            //} else if (c >= 0x80) {
                ...
                //@todo : localize me
                String localizedMessage = MVNCoreResourceBundle.getString(locale, "mvncore.exception.BadInputException.not_good_name", new Object[] {DisableHtmlTagFilter.filter(str),new Character(c)});
