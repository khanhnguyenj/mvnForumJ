/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/taglib/PortletTag.java,v 1.2 2007/05/04 03:33:28 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.2 $
...
public class PortletTag extends TagSupport {
    ...
    public int doStartTag() throws JspTagException {
        ...
        boolean isPortlet = ((environmentService.isPortlet()) && (request.getAttribute("javax.portlet.request") != null));
        if (isPortlet) {
