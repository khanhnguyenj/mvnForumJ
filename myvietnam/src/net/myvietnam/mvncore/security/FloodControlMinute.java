/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/security/FloodControlMinute.java,v 1.8 2009/08/19 10:32:17 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.8 $
 * $Date: 2009/08/19 10:32:17 $
 *
 * ====================================================================
 *
...
/**
 * This class is used to control the number of actions per minute. This is usually
 * used to prevent the flood of any action. You should call FloodControlMinute.setOption()
...
public class FloodControlMinute {
    ...
    /**
     * To set the maximum number of actions per minute for an action.
