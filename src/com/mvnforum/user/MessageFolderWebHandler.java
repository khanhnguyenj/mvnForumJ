/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/MessageFolderWebHandler.java,v 1.40 2009/04/29 08:40:44 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.40 $
 * $Date: 2009/04/29 08:40:44 $
 *
 * ====================================================================
 *
...
public class MessageFolderWebHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(MessageFolderWebHandler.class);
    ...
    public void processAdd(GenericRequest request)
        ...
        if (folderOrder < 10) {
            folderOrder = 10; // Reserve order for special folders
        }
        ...
        try {
            ...
            String localizedMessage = MVNForumResourceBundle.getString(locale, "mvncore.exception.BadInputException.messagefolder_exists", new Object[] {folderName});
