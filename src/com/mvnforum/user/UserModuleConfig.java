/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/UserModuleConfig.java,v 1.16 2008/12/31 04:59:51 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.16 $
 * $Date: 2008/12/31 04:59:51 $
 *
 * ====================================================================
 *
...
public final class UserModuleConfig {
    ...
    private static String urlPattern = "/mvnforum";
    ...
    static {
        try {
            ...
            urlPattern = conf.getString("usermoduleconfig.url_pattern", urlPattern);
        } catch (Exception e) {
