/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/UserModuleProcessor.java,v 1.208 2010/06/17 09:50:27 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.208 $
 * $Date: 2010/06/17 09:50:27 $
 *
 * ====================================================================
 *
...
//          @todo could throw Exception, so onlineUser will be null, caused NPE later
            ...
            if (requestURI.equals("/index")) {
                ...
                request.setAttribute("Reason", MVNForumResourceBundle.getString(locale, "mvnforum.common.action.logout_success"));
        ...
        try {
            ...
            Action action = new ActionInForumUserModule(genericRequest, requestURI);// may throw MissingURLMapEntryException
