/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/auth/MVNForumPermission.java,v 1.67 2009/11/06 09:17:00 nhanld Exp $
 * $Author: nhanld $
 * $Revision: 1.67 $
 ...
 **************************************************************************/
    ...
    public static final int[] globalCMSIndividualPermissionArray =
    {
        ...
        PERMISSION_CMS_VIEW_CHART,
        PERMISSION_CMS_ADD_INTERVIEW,
        PERMISSION_CMS_VIEW_INTERVIEW,
        PERMISSION_CMS_ADD_TO_TAXONOMY,
 ...
 **************************************************************************/
    public static final int[] individualForumAdminPermissionArray =
    {
        PERMISSION_ADD_CATEGORY,
        PERMISSION_EDIT_CATEGORY,
        PERMISSION_DELETE_CATEGORY,
    ...
    public static final int[] individualForumAdminLimitPermissionArray =
    {
        PERMISSION_EDIT_FORUM,
        PERMISSION_DELETE_FORUM,
        PERMISSION_ASSIGN_TO_FORUM,
    ...
    public static final int[] individualForumModeratorPermissionArray =
    {
        PERMISSION_EDIT_CATEGORY,
    ...
    public static final int[] individualPowerUserPermissionArray =
    {
        PERMISSION_USE_MESSAGE,
        PERMISSION_ADD_MESSAGE_ATTACHMENT,
        PERMISSION_USE_AVATAR,
    ...
    public static final int[] individualNormalUserPermissionArray =
    {
        PERMISSION_USE_MESSAGE,
        PERMISSION_USE_AVATAR,
    ...
    public static final int[] individualLimitedUserPermissionArray =
    {
        PERMISSION_READ_POST
    };

    public static final int[] individualLimitedUserLimitPermissionArray =
    {
        PERMISSION_READ_POST
    };
