/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/db/jdbc/RankDAOImplJDBC.java,v 1.19 2009/01/02 15:12:55 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.19 $
...
public class RankDAOImplJDBC implements RankDAO {
    ...
    private static final Logger log = LoggerFactory.getLogger(RankDAOImplJDBC.class);
