/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/admin/ForumAdminServlet.java,v 1.43 2009/12/21 08:51:30 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.43 $
 * $Date: 2009/12/21 08:51:30 $
 *
 * ====================================================================
 *
...
public class ForumAdminServlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(ForumAdminServlet.class);
