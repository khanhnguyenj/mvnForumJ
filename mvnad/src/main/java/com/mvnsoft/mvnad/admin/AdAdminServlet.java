/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/AdAdminServlet.java,v 1.21 2009/12/21 08:53:56 lexuanttkhtn Exp $
 * $Author: lexuanttkhtn $
 * $Revision: 1.21 $
...
public class AdAdminServlet extends HttpServlet {
    ...
    private static final Logger  log                    = LoggerFactory.getLogger(AdAdminServlet.class);
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            try {
                ...
                log.error("Error in AdAdminServlet when getOnlineUser()", e);
                response.setStatus(HttpServletResponse.SC_SERVICE_UNAVAILABLE);
            ...
            log.warn("Exception in AdAdminServlet", e);
        } catch (Throwable e) {
            if (e instanceof BadInputException) {
                ...
                log.error("Exception in AdAdminServlet e = " + e.getMessage(), e);
            } else {
