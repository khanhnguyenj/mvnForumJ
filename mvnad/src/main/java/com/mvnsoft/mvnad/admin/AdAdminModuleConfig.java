/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/admin/AdAdminModuleConfig.java,v 1.5 2008/12/31 04:13:28 trungth Exp $
 * $Author: trungth $
 * $Revision: 1.5 $
...
public final class AdAdminModuleConfig {
    ...
    private static final Logger log = LoggerFactory.getLogger(AdAdminModuleConfig.class);

    private static String urlPattern = "/adadmin";
    ...
    static {
        try {
            ...
            urlPattern = conf.getString("adminmodule.url_pattern", urlPattern);
        } catch (Exception e) {
