/*
 * $Header: /cvsroot/mvnforum/mvnad/src/com/mvnsoft/mvnad/service/impl/MvnAdInfoServiceImplDefault.java,v 1.28 2010/08/20 04:42:03 minhnn Exp $
 * $Author: minhnn $
 * $Revision: 1.28 $
 * $Date: 2010/08/20 04:42:03 $
 *
 * ====================================================================
 *
...
public class MvnAdInfoServiceImplDefault implements MvnAdInfoService {
    ...
    private static String PRODUCT_DESC         = "mvnAd 1.1-dev";

    private static String PRODUCT_VERSION      = "1.1-dev";
