<%--
 - $Header: /cvsroot/mvnforum/mvnad/srcweb/mvnplugin/mvnad/admin/error.jsp,v 1.9 2009/07/16 03:29:35 lexuanttkhtn Exp $
 - $Author: lexuanttkhtn $
 - $Revision: 1.9 $
...
<div class="nav center">
  ...
  <a href="index"><fmt:message key="mvnad.admin.index.title"/></a>&nbsp;&raquo;&nbsp;
